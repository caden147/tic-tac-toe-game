...
* **Join a game:** To join someone else's game, type 'join' followed by your opponent's username. Moves are unable to be made until both players have joined the game. For a game creator or other player to join, type 'join' follwed by your opponent's username.
